...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.mlp_2 = nn.Conv1d(in_channels=4096, out_channels=4096, kernel_size=1)
        self.mlp_3 = nn.Conv1d(in_channels=4096, out_channels=4096, kernel_size=1)
        ...
        self.linear_1 = nn.Linear(in_features=4160, out_features=2048)
