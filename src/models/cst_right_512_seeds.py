...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.seed_mlp_1 = nn.Conv1d(in_channels=3, out_channels=1024, kernel_size=1)
        self.seed_mlp_2 = nn.Conv1d(in_channels=1024, out_channels=512, kernel_size=1)

        self.linear_1 = nn.Linear(in_features=1536, out_features=2048)
