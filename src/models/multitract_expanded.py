...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.mlp_1 = nn.Conv1d(in_channels=6,  out_channels=1024, kernel_size=1)
        self.mlp_2 = nn.Conv1d(in_channels=1024, out_channels=512, kernel_size=1)
        self.mlp_3 = nn.Conv1d(in_channels=512, out_channels=128, kernel_size=1)
        ...
        self.linear_1 = nn.Linear(in_features=192, out_features=512)
    ...
    def forward(self, tom_cloud, seeds_cloud):
        # Encode TOM
        t = self.dropout(self.relu(self.mlp_1(tom_cloud)))
        t = self.dropout(self.relu(self.mlp_2(t)))
