...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.mlp_1 = nn.Conv1d(in_channels=6,  out_channels=4096, kernel_size=1)
        self.mlp_2 = nn.Conv1d(in_channels=4096, out_channels=3096, kernel_size=1)
        self.mlp_3 = nn.Conv1d(in_channels=3096, out_channels=2048, kernel_size=1)
        ...
        self.linear_1 = nn.Linear(in_features=2112, out_features=2048)
