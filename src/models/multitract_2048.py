...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.mlp_3 = nn.Conv1d(in_channels=128, out_channels=512, kernel_size=1)
        self.mlp_4 = nn.Conv1d(in_channels=512, out_channels=2048, kernel_size=1)
        ...
        self.linear_1 = nn.Linear(in_features=2112, out_features=3840)
    ...
    def forward(self, tom_cloud, seeds_cloud):
        ...
        t = self.dropout(self.relu(self.mlp_4(t)))
