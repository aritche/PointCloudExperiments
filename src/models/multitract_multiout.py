...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.mlp_1 = nn.Conv1d(in_channels=6,  out_channels=2048, kernel_size=1)
        self.mlp_2 = nn.Conv1d(in_channels=2048, out_channels=1024, kernel_size=1)
        self.mlp_3 = nn.Conv1d(in_channels=1024, out_channels=512, kernel_size=1)
        ...
        self.linear_1 = nn.Linear(in_features=576, out_features=1024)
        self.linear_2 = nn.Linear(in_features=1024, out_features=3840)
